...
chapters_dir = os.path.join(volumes_dir, "volume05", "chapters")
diagrams_dir = os.path.join(volumes_dir, "volume05", "diagrams")
...
def fix_img_src(match):
    ...
    if src.startswith('../assets/'):
        return f'src="{os.path.join(volumes_dir, "volume05", src)}"'
...
final_pdf = os.path.join(repo_root, "handbooks", "Linux_Support_Engineer_Master_Handbook_Vol5.pdf")
