...
chapters_dir = os.path.join(volumes_dir, "volume04", "chapters")
diagrams_dir = os.path.join(volumes_dir, "volume04", "diagrams")
...
def fix_img_src(match):
    ...
    if src.startswith('../assets/'):
        return f'src="{os.path.join(volumes_dir, "volume04", src)}"'
...
<style>
    ...
    h2.volume-subtitle { color: #7f8c8d; font-size: 24pt; text-align: center; font-style: italic; margin-bottom: 20%; }
...
final_pdf = os.path.join(repo_root, "handbooks", "Linux_Support_Engineer_Master_Handbook_Vol4.pdf")
