...
chapters_dir = os.path.join(volumes_dir, "volume02", "chapters")
diagrams_dir = os.path.join(volumes_dir, "volume02", "diagrams")
...
final_pdf = os.path.join(repo_root, "handbooks", "Linux_Support_Engineer_Master_Handbook_Vol2.pdf")
...
try:
    ...
    with sync_playwright() as p:
        ...
        page.pdf(path=temp_pdf, format="A4", margin={"top": "20mm", "bottom": "20mm", "left": "20mm", "right": "20mm"}, display_header_footer=True, header_template=header_template, footer_template=footer_template, print_background=True)
        browser.close()
    
    # Prepend cover using PyMuPDF if it exists
    cover_pdf_path = os.path.join(build_dir, 'Cover_Vol2.pdf')
