...
To understand why this handbook is structured the way it is, you need to understand what a real shift looks like. You aren't studying these concepts in isolation; you will be juggling them simultaneously while the clock ticks.
...
**12:00 PM — Lunch**
You step away from the terminal. The systems are quiet, but you know that in the afternoon, anything can happen.
...
This book is **Volume 2: Linux Administrator**. It is the foundation of the 5-volume *Linux Support Engineer Master Handbook* series. 
